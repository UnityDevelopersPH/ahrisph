       ...
       <div class="container">
         <div class="header-body">
           <div class="row align-items-center">
             <div class="col-lg-6">
               <div class="pr-5">
                 <h1 class="display-2 text-white font-weight-bold mb-0">An Accounting and CRM Platform.</h1>
                 <h2 class="display-4 text-white font-weight-light">for small business.</h2>
                 <p class="text-white mt-4">Ahris is perfect for every companies that has a blank this is a sample paragraph with sample and every wanderful admin dashboard and user-friendly ui.D</p>
                 <div class="mt-5">
                 ...
                 <div class="col-md-6">
                   <div class="card">
                     <div class="card-body">
                       ...
                       <h5 class="h3">Company Account</h5>
                       <p>Ahris comes with over 70 handcrafted components.</p>
                     </div>
                   </div>
                   <div class="card">
                     <div class="card-body">
