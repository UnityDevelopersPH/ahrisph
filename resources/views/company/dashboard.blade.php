...
<head>
  @include('company-layouts.asset-css')
</head>

<body>
  <!-- Sidenav -->
    @include('company-layouts.side-nav')
  <!-- Main content -->
          ...
          <!-- Company Name -->
            <div class="form-group mb-0">
              <div class="input-group input-group-alternative input-group-merge">
                  <h1 class="display-5" id="company-name"> Company Name Here </h1>
              </div>
            </div>
          <!-- Navbar links -->
  ...
  @include('company-layouts.asset-js')
</body>
